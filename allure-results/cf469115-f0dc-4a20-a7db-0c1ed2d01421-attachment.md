...
```
Error: ENOENT: no such file or directory, stat 'C:\Users\aa1n1\Downloads\PW-demo.worktrees\agents-acceptable-gecko\Usersaa1n1DownloadsPW-demo.worktreesagents-acceptable-gecko	estdataUfile.png'
```
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e57]:
    ...
    - paragraph [ref=e73]:
      - text: "Back to:"
      - link "Multiple File Upload Input" [ref=e74]:
        - /url: https://davidwalsh.name/multiple-file-upload
```
...
```ts
  ...
  6 | 
> 7 | await page.locator("#filesToUpload").setInputFiles("C:\Users\aa1n1\Downloads\PW-demo.worktrees\agents-acceptable-gecko\testdata\Ufile.png"); 
    |  ^ Error: ENOENT: no such file or directory, stat 'C:\Users\aa1n1\Downloads\PW-demo.worktrees\agents-acceptable-gecko\Usersaa1n1DownloadsPW-demo.worktreesagents-acceptable-gecko	estdataUfile.png'
